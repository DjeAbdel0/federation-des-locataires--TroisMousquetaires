...
<header>
  ...
  <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="navbar-brand">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/medias/logo/logo_nouveau.png" alt="Logo" class="logo_nav">
    </a>
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item"><a href="<?php echo esc_url( home_url( '/news-hub' ) ); ?>" class="nav-link font-weight-bold text-uppercase">Nouvelles</a></li>
                    ...
                    <div class="row">
                      <div class="col-lg-6 mb-4">
                        <ul class="list-unstyled">
                          <li class="nav-item"><a href="<?php echo esc_url( home_url( '/se' ) ); ?>" class="nav-link text-small pb-0">Tous les services</a></li>
                          <li class="nav-item"><a href="<?php echo esc_url( home_url( '/services/association/' ) ); ?>" class="nav-link text-small pb-0">Crr</a></li>
        ...
        <li class="nav-item"><a href="<?php echo esc_url( home_url( '/team' ) ); ?>" class="nav-link font-weight-bold text-uppercase">Équipe</a></li>
        <li class="nav-item"><a href="<?php echo esc_url( home_url( '/contactez-nous' ) ); ?>" class="nav-link font-weight-bold text-uppercase">Nous joindre</a></li>
        <li class="nav-item"><a href="<?php echo esc_url( home_url( '/about' ) ); ?>" class="nav-link font-weight-bold text-uppercase">À propos</a></li>
        
        <form role="search" aria-label="Site search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
          <input type="search" class="navbar__search" placeholder="Search..." aria-label="Search" name="s" value="<?php echo get_search_query(); ?>">
